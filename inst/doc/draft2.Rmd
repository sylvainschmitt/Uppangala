...
1. Do variations and covariations in functionnal traits reveal species ecological strategies ?
...
<!-- Use of canopy height and basal area as biotic factors of our 5 functional traits was justified by structural equation modelling (see supplementary material S2). -->
...
com@data$BA <- aggregate(Trees$`2013_girth`, list(Trees$com), function(x){sum(pi*(x/(2*pi))^2, na.rm = T)})[,2]
...
In order to see if or if environmental biotic factors were the results of functional traits we used structural equation modelling. Three latent variables were defined: *Abiotic environment* defined with selected topographical variables, *Biotic environment* defined with our 2 selected biotic variables, and *functional traits* defined with our 5 functional traits. Two models were compared, a first one with the functional traits explained by both abiotic and biotic factors (**m1** *Traits ~ Abiotic + Biotic*), and a second one with the biotic factors explained by the functional traits and abiotic factors (**m2** *Biotic ~ Traits + Abiotic*). Models were compared with a Chi Square Difference test on Aikaike's Criterion Indice (AIC). 

Structural equation modelling (SEM) revealed that environmental biotic factors were influencing functional traits and not the contrary. Effectively retained model was the first one (**m1** *Traits ~ Abiotic + Biotic*, see supplementary material S1) with a significantly lower AIC on Chi Square Difference test ($AIC = 13195$ against $AIC = 13238$ with $p.value < 0.001$).
...
## S3: Phylogenetic signal among functional traits by correlogram
...
Supplementary materials S3: Correlogram of phylogenetic signal among the 5 functional traits.
