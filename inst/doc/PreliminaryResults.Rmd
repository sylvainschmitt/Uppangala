...
```{r RLQ2, eval=FALSE, include=FALSE}
library(ade4)
...
model = 6
rd <- randtest(rlq, modeltype = model)
fq <- fourthcorner.rlq(rlq, type = "Q.axes", modeltype = model)
fr <- fourthcorner.rlq(rlq, type = "R.axes", modeltype = model)
fqr <- fourthcorner(Rm, Lm, Qm, modeltype = model)
...
plot(rd)
alpha = 0.5
plot(fq, alpha = alpha, stat = "D2")
plot(fr, alpha = alpha, stat = "D2")
plot(fqr.adj, alpha = alpha, stat = "D2")
plot(fqr.adj, x.rlq = rlq, alpha = alpha, stat = "D2", type = "biplot")
```
